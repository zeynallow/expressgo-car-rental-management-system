...
<head>
  ...
  .col-print-6 {width:50%; float:left;    padding:5px;}
  ...
  <div class="container">
   ...
   if(!empty($agreements)){
    ...
    foreach ($agreements as $agreement) {
      ...
      <div class="row">
              ...
              <div class="col-print-6">
                ...
                <table class="table">
                  ...
                  <tr>
                    <td><?=$this->lang->line('subtotal');?></td> <td><?php echo $agreement['subtotal'];?></td>
                  </tr>
                  <tr>
                    <td><?=$this->lang->line('tax');?></td> <td><?php echo $agreement['tax'];?> %</td>
                  </tr>
                  <tr>
                    <td><?=$this->lang->line('total');?></td> <td><?php echo $agreement['total'];?></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="sign">
       <p><?=$this->lang->line('signature_renters');?> _____________________________</p>
       <br/>
       <p><?=$this->lang->line('signature_driver');?> _____________________________</p>
     </div>
    </div>
  </div>
