    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h4 class="title"><?=$this->lang->line('edit');?> - <?php echo $form_contents['make'];?> <?php echo $form_contents['model'];?></h4>
                    </div>
                    <div class="content">
                        <?php echo form_open_multipart('vehicles/edit/'.$form_contents['id'].''); ?>
                        <div class="row">
                            <div class="col-md-3">
