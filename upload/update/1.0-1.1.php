...
// Path to the system directory
    ...
    if($_POST) {
        ...
        if($core->validate_post($_POST) == true)
        {
            ...
            } else if ($database->create_tables($_POST,'1.0-1.1') == false) {
    ...
    <head>
        ...
        <title>ExpressGo - Update 1.0 to 1.1</title>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2>ExpressGo</h2>
                                <span>Car Rental Management Systems v1.0</span>
                            </div>
                        </div>
                        <hr/>
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                                ...
                                <form id="install_form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    <div class="card">
                                        <div class="header">
                                            <h3 class="title">Update 1.0 to 1.1</h3>
