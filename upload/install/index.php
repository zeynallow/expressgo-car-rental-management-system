    ...
    if($_POST) {
        ...
        if($core->validate_post($_POST) == true)
        {
            ...
            if(!isset($message)) {
                ...
                echo '<meta http-equiv="refresh" content="3; url='.$config['base_url'].'index.php/profile" />';           
            }
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <h2>ExpressGo</h2>
                                <span>Car Rental Management System v1.2</span>
                            </div>
                        </div>
                        <hr/>
                        <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="text-center">
                                                <button type="submit" class="btn btn-fill btn-wd ">Install</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
